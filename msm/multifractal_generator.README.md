			...
			multifractal_generator


			Compiling command (using cc):
	+--------------------------------------------------------+

cc -lm -I<path> -o multifractal_generator.exe multifractal_generator.c
...
=====================
 ...
 scale invariance in the derivative or the wavelets-on-measures methods. Ask
 Antonio for a more detailed information.
...
Default:0
 ...
 -hinf: Float variable. Minimum singularity in log-Poisson MFs
and binomial MFs. Default: -0.5


 -Codinf : Float variable. Most singular codimension. Valid for log-Poissons
and binomials. Default: 1.00
...
MEMORY PARAMETERS
=================
  This variable is inherited from FFT1D.c and FFT2D.c
...
========================
  Variables inherited from derivacion_1D.c and derivacion_2D.c
...
WAVELET VARIABLES
=================
   Inherited from multifractal_1D.c and multifractal_2d.c. They are used for
...
program will generate a plotable .txt file (for 1D series) or a GIF image (2D
data).
...
: generates 10
log-Poisson (with default choice of parameters) 1D series of 4096 elements and 
...
: generates 10 log-Levi 1D series of 16384 elements, with alpha=1.5
sigma=1 and the mean adjusted by the requirement of translational invariance
(mean=0.33), and analizes them.
