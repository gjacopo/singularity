% ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
% MYCONTWTPART - Estimates the partition function of a 1-D signal from the  
...
% See function MYCONTWTSPEC.
% ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
function [part, maxmap]  = mycontwtpart( wt, scale, Q, FindMax )
% Usage
%        [part, maxmap] = mycontwtpart( wt, scale, Q, FindMax )
% Input parameters
...
for nq = 1:length(Q)
  for j=1:nscale
    ...
    % note: in our study, the signals have the same size
  end
end
